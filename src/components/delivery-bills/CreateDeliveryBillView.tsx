...
interface CreateDeliveryBillViewProps {
  userId: string;
}

export function CreateDeliveryBillView({ userId }: CreateDeliveryBillViewProps) {
  ...
  // Trigger unpaid orders query for delivery bill
  const {
    data: unpaidData,
  ...
  const createDeliveryBillMutation = useCreateDeliveryBill();
      ...
      <div className="flex items-center justify-between pb-2 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <Button
            ...
            onClick={() =>
              router.push(
                `/dashboard/vendors/${userId}/delivery-bills?tab=delivery_bills`,
              )
            }
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-gray-100">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="w-[240px]">
                <Popover>
                  <PopoverTrigger
                    id="date-picker-range-delivery-bill-unpaid"
                    className={cn(
                      buttonVariants({
                        variant: "outline",
                        className:
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-gray-100 mt-2">
            <Button
              onClick={() => {
                ...
                createDeliveryBillMutation.mutate(
                  {
                    user: Number(userId),
                    orders: selectedIds,
              ...
              disabled={
                selectedIds.length === 0 || createDeliveryBillMutation.isPending
              }
            ...
            >
              {createDeliveryBillMutation.isPending ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
                  Creating Delivery Bill...
                </>
              ) : (
                <>
            ...
            <Button
              ...
              disabled={createDeliveryBillMutation.isPending}
            >
              Cancel
            </Button>
          </div>
